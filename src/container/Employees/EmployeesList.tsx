import {FlatList, Image, ScrollView, StyleSheet, View, Text, TouchableOpacity, TextInput, LayoutAnimation} from "react-native";
...
export default function EmployeesList(props: EmployeesListProps): JSX.Element {
    ...
    return (
      <ContainerLayout>
        ...
        <TextInput clearButtonMode="always"
          ...
          placeholder='Suche nach Personen oder Eigenschaften.'
          value={searchQuery}
